      ...
      child:
              ...
              APIService.register(model).then((response) {
                ...
                if (response.data != null) {
                  FormHelper.showSimpleAlertDialog(
                      context, Config.name, "Registration Success, please Login to the account", "OK", () {
                    Navigator.pushNamedAndRemoveUntil(context, '/login', (route) => false);
                  });
                } else {
                  FormHelper.showSimpleAlertDialog(context, Config.name, response.message, "OK", () {
                    Navigator.pop(context);
                  });
                }
              });
            }
          }, btnColor: HexColor("#283B71"), borderColor: Colors.white, txtColor: Colors.white, borderRadius: 10),
        ),
        SizedBox(height: 20),
        Center(
          child: Text(
        ...
        Align(
          ...
          child: Padding(
            ...
            child: RichText(
                text: TextSpan(style: TextStyle(fontSize: 14.0, color: Colors.grey), children: <TextSpan>[
